...
function getForm() {
    ...
    let timeStart = document.querySelector("#cal-timeStart").value
    let timeEnd = document.querySelector("#cal-timeEnd").value
    let docente = document.querySelector("#cal-docente").value
    let turma = document.querySelector("#cal-turma").value
    let etiqueta = document.querySelector("#cal-etiqueta").value
    let ambiente = document.querySelector("#cal-rooms").innerText
    let diaSemana = document.querySelector("#cal-diasemana").value
    let calInfo = document.querySelector(".cal-info")
    let codAmbiente = document.querySelector("#cal-rooms").value

    // window.app.receive("onAddEvent", [
    //     timeStart,
    //     timeEnd,
    //     docente,
    //     turma,
    ...
    //     calInfo.innerHTML = "Registrando..."

    //     if (res.status) {
    //         loadEvents()
    //     }

    //     calInfo.innerHTML = res.msg
    // })
}
